...
# The champion for v8 testing is v7.1: the v6 engine with the 16-zone net (072-kz16).
BASE=overnight/challengers/072-kz16
say "queue8 start (base $BASE; 091-093 run on the desktop)"
